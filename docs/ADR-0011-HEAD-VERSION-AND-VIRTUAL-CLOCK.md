...
ADR-0026 through ADR-0034 separately accept deterministic modeled entropy, a
...
bounded runtime-bound local TwinSpec-action subset. They do not accept
scheduled Agent/provider/external execution.
