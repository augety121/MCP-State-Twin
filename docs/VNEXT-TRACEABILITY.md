...
| `11-SPEC-0015-RESOURCE-GOVERNANCE.md` | Adopted / partial | ADR-0013 adds a versioned profile, `statetwin limits`, environment digest binding, typed `RESOURCE_LIMIT`, and fail-closed local state/input/output/diff/storage bounds. ADR-0018 adds bundle limits, ADR-0019 an Episode-record bound, and ADR-0020 attempt/lease bounds. OS quotas, distributed fairness, scheduler/cassette quotas, retention, and empirical performance budgets remain open. |
