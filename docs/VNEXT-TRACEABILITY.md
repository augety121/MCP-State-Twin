...
| `03-SPEC-0007-VIRTUAL-TIME-ENTROPY-SCHEDULER.md` | Adopted / partial | ADR-0011 accepts private clock/head semantics; ADR-0026 through ADR-0028 accept bounded modeled entropy, a branch-local opaque signal queue and atomic due delivery. Scheduled tool/Agent effects, recurrence and cascades remain proposals. |
...
| `11-SPEC-0015-RESOURCE-GOVERNANCE.md` | Adopted / partial | ADR-0013 adds a versioned semantic profile; ADR-0018 through ADR-0020 add bundle/Journal/remote bounds; ADR-0026 through ADR-0028 add entropy/signal bounds in `local-preview-v5`. ADR-0022 through ADR-0024 separately add operational CPU/heap/HTTP controls. OS/RSS hard quotas, child/native control, durable queues, distributed fairness, cassette quotas, retention and empirical performance budgets remain open. |
