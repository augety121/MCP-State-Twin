...
| `11-SPEC-0015-RESOURCE-GOVERNANCE.md` | Adopted / partial | ADR-0013 adds a versioned semantic profile and fail-closed local bounds; ADR-0018 through ADR-0020 add bundle, Journal, attempt and lease bounds. ADR-0022 through ADR-0024 separately add a default one-slot Go scheduler policy, Go heap soft target and bounded non-queueing HTTP admission. OS/RSS hard quotas, child/native control, durable queues, distributed fairness, scheduler/cassette quotas, retention and empirical performance budgets remain open. |
